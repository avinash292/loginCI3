<div class="container">
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <form action="<?php echo base_url('user/add_property_details');?>/<?php echo $pd[0]['id']?>" method="post"
                style="margine-top:7px;">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="Agent Name"
                                                    name="a_name" value="<?php echo $pd[0]['a_name']?>">
                                                <small class=" error"><?php echo form_error('a_name');?></small>
                                            </div> <!-- form-group end.// -->
                                            <div class="form-group col-sm-6">
                                                <label>Area SQRFT</label>
                                                <input class="form-control" type="text" name="area"
                                                    placeholder="Area sqrft" value="<?php echo $pd[0]['area']?>">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-6">
                                                ...
                                                <input type="text" class="form-control" placeholder="Facilities"
                                                    name="facilities" value="<?php echo $pd[0]['facilities']?>">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="u_id"
                                                value="<?php echo $this->session->userdata('session_data')['u_id'];?>" />
